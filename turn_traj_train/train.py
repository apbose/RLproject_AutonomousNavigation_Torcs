...
def playGame(finetune=0):
    ...
    demo_dir = "/home/Apurba/Documents/RL/human_1/"
    param_dir = "/home/Apurba/Documents/RL/wgail_info_params_1/"
    pre_actions_path = "/home/Apurba/Documents/RL/human_1/pre_actions.npz"
    feat_dim = [7, 13, 1024]
    img_dim = [50, 50, 3]
    aux_dim = 10
    encode_dim = 2
    ...
    demo = np.load(demo_dir + "demo_collected.npz")
